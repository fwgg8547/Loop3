...
import com.fwgg8547.loop2.gamebase.layerbase.riGraphicTools;
...
{
	private static String TAG = "TextMng";
  ...
  public final static int[] l_size = {36,29,30,34,25,25,34,33,
  ...
  public List<TextObject> txtcollection;
	
	public TextManager(Context ctx)
	{
		// Create our container
		txtcollection = new ArrayList<TextObject>();
	...
	public void AddCharRenderInformation(float[] vec, float[] cs, float[] uv, short[] indi)
	{
		...
		// translate the indictes to align with the vertexlocation in ou
	...
	public void Draw(float[] m)
	{
		...
		GLES20.glUniform1i ( mSamplerLoc, texturenr);//texturenr);
